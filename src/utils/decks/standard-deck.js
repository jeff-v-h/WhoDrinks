...
export const cardContentList = [
  ...
  'Everyone who has a hidden tatto must drink.',
  ...
  'Every player who as born in late September take a drink. Did you ever realise that your parents probably did it over the christmas break?',
  ...
  'Drink if your family has more then 3 members in it.',
  ...
  "Everybody guess my phone's battery precentage. The person closest chooses someone to drink.",
  ...
  'All players who has caught a share ride in the past month must drink.',
  ...
  "Every player who has both their hands touching have a sip. Have another if you're touching someone else.",
  ...
  'Vote for the person who is most likely to a motivational quote on an online bio. This person must drink.',
  ...
  'Everyone who has gotten high in the past week must take a drink.',
  ...
  'Everyone must have one drink for ever teacher, lecturer or tutor they have had a crush on.',
  ...
  'Drink if you do cooked for yourself yesterday. Good on you for being a real adult.',
  ...
  "Drink if yopu're not wearing a bra.",
  ...
  "Each person must drink if they've ever been to class high or hungover.",
  ...
  'Everyone who has seen ever sent or received a dick pic must have a drink.',
  ...
  "If you've ever been a hike, take a sip.",
  ...
  "If I don't have an Instagram account, drink.",
  ...
  'Drink if you only speak one English.',
