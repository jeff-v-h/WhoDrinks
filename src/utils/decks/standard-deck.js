...
export const cardContentList = [
  ...
  'Quick: last person to slap their own backside drinks.',
  'Players who currently have lip balm with them, open up those moisturised lips and take a sip.',
  "If you've ever flown first or business class, you may have the privilege to choose someone else to have a drink.",
